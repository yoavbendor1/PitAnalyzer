function [bb,A] = PitAnalyzer_minAreaBoundingBox(V,antipodal_pairs)
% Copyright 2017-2018 The MathWorks, Inc.
% https://blogs.mathworks.com/steve/2018/04/17/feret-properties-wrapping-up/

if nargin < 2
    antipodal_pairs = PitAnalyzer_antipodalPairs(V);
end
...
for k = 1:n
    ...
    if ~isempty(pt1)
        ...
        h = PitAnalyzer_triangleHeight(pt1,pt2,pt3);
        
        pt1pt2_direction = atan2d(pt2(2)-pt1(2),pt2(1)-pt1(1));
        
        w = PitAnalyzer_feretDiameter(V,pt1pt2_direction);
